...
Self-hosted social media scheduling and automation server (Go backend, embedded React SPA) for Mastodon, Bluesky, and Friendica. This is the DOX rail: project-wide rules, the DOX framework, the TDD workflow, and the top-level Child DOX Index.
